...
color_t aqiColors[6] = { GREEN, YELLOW, ORANGE, RED, PURPLE, MAROON };
...
const float temperatureThresholds[] = { -100, 4, 10, 18, 20, 24, 27, 30, 33, 36, 100 };
...
void setAqiColor(float aqiCatPos) {
  byte aqiCat = aqiCatPos;
  aqiCatPos -= aqiCat;
  setMixedColor(aqiColors[aqiCat], aqiColors[aqiCat + 1], aqiCatPos);
}
